...
\section{Unicycle robots}
	...
	Based on the work in 2011, the decision was made to move from the large and dangerous platform described there (\label{fig:uni-old}) to a much smaller and safer model (\label{fig:uni-new}).
