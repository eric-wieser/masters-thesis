...
\section{Software design}
	...
	\todo{I think it's important to include this somewhere, as it motivated a lot of the software changes. But maybe not here. }
	...
	\todo{Some of these are mentioned elsewhere, so maybe the list should go}
	\begin{multicols}{2}
		\raggedcolumns
		\noindent
		In the Matlab code:
