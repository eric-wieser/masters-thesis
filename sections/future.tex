...
\section{Automatic Differentiation}
	...
	A quadratic policy has been implemented on the robot and in the communication protocol (\cref{sec:comms}) as a \cpp{QuadraticPolicy} message, but no Matlab code currently exists to convert the \textsc{Pilco} policy object into a suitable protobuf message, nor has any testing been performed.
